...
st.write("A professional Custom based real-time face anti-spoofing and image quality assessment system.")
...
while cap.isOpened():
    if stop_button:  # Check if the "Stop" button is pressed
        st.warning("Webcam feed stopped by the user.")
        break
